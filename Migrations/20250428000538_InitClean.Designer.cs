...
namespace AdopcionPET.Migrations
{
    ...
    [Migration("20250428000538_InitClean")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdopcionPET.Models.Adopcion", b =>
                {
            ...
            modelBuilder.Entity("AdopcionPET.Models.Adoptante", b =>
                {
                    b.Property<int>("AdoptanteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AdopcionPET.Models.Mascota", b =>
                {
                    b.Property<int>("MascotaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AdopcionPET.Models.Adopcion", b =>
                {
                    b.HasOne("AdopcionPET.Models.Adoptante", "Adoptante")
                        .WithMany("Adopciones")
                        .HasForeignKey("AdoptanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdopcionPET.Models.Mascota", "Mascota")
                        .WithOne("Adopcion")
                        .HasForeignKey("AdopcionPET.Models.Adopcion", "MascotaId")
